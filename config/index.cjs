...
//       useTemplateId: 'C-wPKhTIUYlmXk0UbyafvtR-QKdGkWYbUNlKfIceN1g',
...
//     },
    {
      ...
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      useTemplateId: 'DYDaFUyqv_JX9jjfkRsXOGcZgH9f4Tr24NpNJ7s5CFY',
      // 新历生日, 仅用作获取星座运势, 格式必须为MM-DD
      horoscopeDate: '01-27',
  ...
  CALLBACK_TEMPLATE_ID: '4esZb7s55QVb_R8dUdoAIc5eJd-pdvVTXuhHFBZUMIg',
